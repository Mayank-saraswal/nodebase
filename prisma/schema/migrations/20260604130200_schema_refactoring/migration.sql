...
-- CreateEnum
CREATE TYPE "CredentialType" AS ENUM ('OPENAI', 'ANTHROPIC', 'GEMINI', 'DEEPSEEK', 'PERPLEXITY', 'XAI', 'GROQ', 'GMAIL', 'GMAIL_OAUTH', 'GOOGLE_SHEETS', 'GOOGLE_DRIVE', 'WHATSAPP', 'NOTION', 'RAZORPAY', 'SLACK', 'MSG91', 'SHIPROCKET', 'ZOHO_CRM', 'HUBSPOT', 'FRESHDESK', 'CASHFREE', 'POSTGRES');
...
-- ─────────────────────────────────────────────────────────────
-- GitHub Node Schema Objects
-- Added: GITHUB/GITHUB_TRIGGER NodeTypes, GITHUB/GITHUB_APP CredentialTypes,
--        GitHubOperation enum, GitHubNode table, GitHubTriggerNode table
-- ─────────────────────────────────────────────────────────────

-- AlterEnum: Add GITHUB and GITHUB_TRIGGER to NodeType
ALTER TYPE "NodeType" ADD VALUE 'GITHUB';
ALTER TYPE "NodeType" ADD VALUE 'GITHUB_TRIGGER';

-- AlterEnum: Add GITHUB and GITHUB_APP to CredentialType
ALTER TYPE "CredentialType" ADD VALUE 'GITHUB';
ALTER TYPE "CredentialType" ADD VALUE 'GITHUB_APP';

-- CreateEnum
CREATE TYPE "GitHubOperation" AS ENUM (
  'REPOSITORY_CREATE', 'REPOSITORY_GET', 'REPOSITORY_LIST', 'REPOSITORY_UPDATE',
  'REPOSITORY_DELETE', 'REPOSITORY_FORK', 'REPOSITORY_LIST_CONTRIBUTORS',
  'REPOSITORY_LIST_LANGUAGES', 'REPOSITORY_TRANSFER', 'REPOSITORY_DISPATCH',
  'REPOSITORY_CHECK_COLLABORATOR', 'REPOSITORY_LIST_EVENTS',
  'ISSUE_CREATE', 'ISSUE_GET', 'ISSUE_UPDATE', 'ISSUE_CLOSE', 'ISSUE_REOPEN',
  'ISSUE_LIST', 'ISSUE_ADD_LABELS', 'ISSUE_REMOVE_LABEL', 'ISSUE_CREATE_COMMENT',
  'ISSUE_LIST_COMMENTS', 'ISSUE_UPDATE_COMMENT', 'ISSUE_DELETE_COMMENT',
  'ISSUE_ASSIGN', 'ISSUE_UNASSIGN',
  'PULL_REQUEST_CREATE', 'PULL_REQUEST_GET', 'PULL_REQUEST_LIST',
  'PULL_REQUEST_UPDATE', 'PULL_REQUEST_MERGE', 'PULL_REQUEST_CLOSE',
  'PULL_REQUEST_REOPEN', 'PULL_REQUEST_LIST_REVIEWS', 'PULL_REQUEST_CREATE_REVIEW',
  'PULL_REQUEST_REQUEST_REVIEWERS', 'PULL_REQUEST_LIST_COMMITS',
  'PULL_REQUEST_LIST_FILES', 'PULL_REQUEST_CREATE_REVIEW_COMMENT',
  'FILE_GET', 'FILE_CREATE', 'FILE_UPDATE', 'FILE_DELETE', 'FILE_LIST',
  'FILE_GET_CONTENTS', 'FILE_CREATE_OR_UPDATE',
  'BRANCH_LIST', 'BRANCH_GET', 'BRANCH_CREATE', 'BRANCH_DELETE',
  'BRANCH_RENAME', 'BRANCH_SET_PROTECTION',
  'RELEASE_CREATE', 'RELEASE_GET', 'RELEASE_LIST', 'RELEASE_UPDATE',
  'RELEASE_DELETE', 'RELEASE_UPLOAD_ASSET',
  'WORKFLOW_LIST', 'WORKFLOW_GET', 'WORKFLOW_DISPATCH', 'WORKFLOW_RUN_LIST',
  'WORKFLOW_RUN_GET', 'WORKFLOW_RUN_CANCEL', 'WORKFLOW_RUN_RE_RUN',
  'WORKFLOW_RUN_LIST_JOBS',
  'GIST_CREATE', 'GIST_GET', 'GIST_LIST', 'GIST_UPDATE', 'GIST_DELETE', 'GIST_STAR',
  'SEARCH_REPOSITORIES', 'SEARCH_ISSUES', 'SEARCH_PULL_REQUESTS', 'SEARCH_CODE',
  'SEARCH_USERS', 'SEARCH_COMMITS', 'SEARCH_TOPICS',
  'USER_GET', 'USER_GET_CURRENT', 'USER_LIST_REPOS', 'USER_LIST_FOLLOWERS',
  'USER_LIST_FOLLOWING',
  'ORG_GET', 'ORG_LIST', 'ORG_LIST_MEMBERS', 'ORG_LIST_TEAMS', 'ORG_LIST_REPOS',
  'ORG_CREATE_REPO', 'ORG_INVITE_MEMBER', 'ORG_REMOVE_MEMBER',
  'DISCUSSION_CREATE', 'DISCUSSION_GET', 'DISCUSSION_LIST', 'DISCUSSION_UPDATE',
  'DISCUSSION_DELETE',
  'CODESPACES_LIST', 'CODESPACES_GET', 'CODESPACES_CREATE', 'CODESPACES_START',
  'CODESPACES_STOP', 'CODESPACES_DELETE', 'CODESPACES_UPDATE', 'CODESPACES_EXPORT',
  'CODESPACES_LIST_FOR_REPO', 'CODESPACES_LIST_MACHINE_TYPES',
  'CODESPACES_LIST_SECRETS', 'CODESPACES_CREATE_SECRET',
  'COPILOT_LIST_SEATS', 'COPILOT_ADD_SEAT', 'COPILOT_REMOVE_SEAT',
  'COPILOT_GET_SETTINGS', 'COPILOT_UPDATE_SETTINGS', 'COPILOT_LIST_SPACES',
  'COPILOT_GET_SPACE', 'COPILOT_CREATE_SPACE', 'COPILOT_UPDATE_SPACE',
  'COPILOT_DELETE_SPACE', 'COPILOT_LIST_SPACE_RESOURCES',
  'COPILOT_ADD_SPACE_RESOURCE', 'COPILOT_REMOVE_SPACE_RESOURCE',
  'COPILOT_GET_AGENT_POLICY', 'COPILOT_UPDATE_AGENT_POLICY',
  'RULESET_LIST', 'RULESET_GET', 'RULESET_CREATE', 'RULESET_UPDATE',
  'RULESET_DELETE', 'RULESET_LIST_RULE_EVALUATIONS', 'RULESET_GET_RULE_SUITE',
  'RULESET_LIST_ORG_RULESETS',
  'ENVIRONMENT_LIST', 'ENVIRONMENT_GET', 'ENVIRONMENT_CREATE', 'ENVIRONMENT_UPDATE',
  'ENVIRONMENT_DELETE', 'ENVIRONMENT_LIST_SECRETS', 'ENVIRONMENT_GET_SECRET',
  'ENVIRONMENT_CREATE_SECRET', 'ENVIRONMENT_DELETE_SECRET',
  'ENVIRONMENT_LIST_PROTECTION_RULES',
  'SECRET_LIST_REPO', 'SECRET_GET_REPO', 'SECRET_CREATE_REPO', 'SECRET_DELETE_REPO',
  'SECRET_LIST_ORG', 'SECRET_GET_ORG', 'SECRET_CREATE_ORG', 'SECRET_DELETE_ORG',
  'SECRET_GET_PUBLIC_KEY', 'SECRET_GET_ORG_PUBLIC_KEY',
  'SECRET_LIST_SELECTED_REPOS', 'SECRET_SET_SELECTED_REPOS',
  'DEPLOYMENT_LIST', 'DEPLOYMENT_GET', 'DEPLOYMENT_CREATE',
  'DEPLOYMENT_LIST_STATUSES', 'DEPLOYMENT_GET_STATUS', 'DEPLOYMENT_CREATE_STATUS',
  'DEPLOYMENT_DELETE', 'DEPLOYMENT_SET_STATUS',
  'PACKAGE_LIST_FOR_USER', 'PACKAGE_LIST_FOR_ORG', 'PACKAGE_GET', 'PACKAGE_DELETE',
  'PACKAGE_RESTORE', 'PACKAGE_LIST_VERSIONS', 'PACKAGE_GET_VERSION',
  'PACKAGE_DELETE_VERSION', 'PACKAGE_RESTORE_VERSION', 'PACKAGE_LIST_DOCKER_IMAGES',
  'ATTESTATION_LIST_FOR_REPO', 'ATTESTATION_GET', 'ATTESTATION_CREATE',
  'ATTESTATION_LIST_FOR_ORG', 'ATTESTATION_VERIFY',
  'AGENT_TASK_LIST', 'AGENT_TASK_GET', 'AGENT_TASK_CREATE', 'AGENT_TASK_UPDATE',
  'AGENT_TASK_CANCEL', 'AGENT_TASK_GET_LOGS',
  'ARTIFACT_LIST', 'ARTIFACT_GET', 'ARTIFACT_DELETE', 'ARTIFACT_DOWNLOAD',
  'ARTIFACT_UPLOAD', 'ARTIFACT_GET_ARCHIVE_URL',
  'PROJECT_V2_LIST', 'PROJECT_V2_GET', 'PROJECT_V2_CREATE', 'PROJECT_V2_UPDATE',
  'PROJECT_V2_DELETE', 'PROJECT_V2_LIST_ITEMS', 'PROJECT_V2_ADD_ITEM',
  'PROJECT_V2_UPDATE_ITEM', 'PROJECT_V2_DELETE_ITEM', 'PROJECT_V2_LIST_FIELDS',
  'PROJECT_V2_CREATE_FIELD', 'PROJECT_V2_UPDATE_FIELD_VALUE',
  'ADVISORY_LIST', 'ADVISORY_GET', 'ADVISORY_CREATE', 'ADVISORY_UPDATE',
  'ADVISORY_LIST_REPOS_AFFECTED', 'ADVISORY_REPORT'
);

-- CreateTable: GitHubNode
